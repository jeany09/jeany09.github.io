...
### [我的博客在这里](http://jeany09.github.io)

### [模板在这里](http://jeany09.github.io/myblog/)

我的博客仓库——`jeany09.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`myblog`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。
...
* 如果你喜欢我的这个博客模板，请在`jeany09.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: Hiven Blog             # 你的博客网站标题
SEOTitle: Hiven Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: jeany09     # 你的github账号
weibo_username: jeany09      # 你的微博账号，底部链接会自动更新的。
